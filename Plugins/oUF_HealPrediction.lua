--[[ Element: Heal Prediction
 ...
 RainHealPrediction - A table containing `myBar`, `otherBar`, `absorbBar`
  and `overAbsorbGlow`
...
local Update = function(self, event, unit)
	...
	local hp = self.RainHealPrediction
...
local Path = function(self, ...)
	return (self.RainHealPrediction.Override or Update) (self, ...)
end
...
oUF:AddElement('rain_HealPrediction', Path, Enable, Disable)
